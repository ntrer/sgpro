<template>
  <div class="app-container">
    ...
    <el-table border v-loading="loading" :data="redEnvelopesRecordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="昵称" align="center" prop="name" width="180"/>
      <el-table-column label="手机号" align="center" prop="phone" width="180"/>
      <el-table-column label="意向商品" align="center" prop="goodsName" width="180" />
      <el-table-column label="客户所在小区" align="center" prop="address" width="180" />
      ...
      <el-table-column label="客户星级" align="center" prop="star" width="140" :formatter="starFormat"/>
...
<script>
import { listinputMember } from "@/api/extensionManage/activityCard";
...
export default {
  ...
  methods: {
    ...
    /** 查询红包领取记录列表 */
    getList() {
      listinputMember(this.queryParams).then(response => {
