<template>
  <div class="app-container">
    ...
    <el-table border v-loading="loading" :data="redEnvelopesRecordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="邀约导购" align="center" prop="userName" width="180"/>
      ...
      <el-table-column label="是否是导购" align="center" prop="isUser" width="140" :formatter="isUserFormat"/>
...
<script>
import { listactivityAuthInfo} from "@/api/extensionManage/activityCard";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listactivityAuthInfo(this.queryParams).then(response => {
