<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" border :data="shopPayInfoList" @selection-change="handleSelectionChange">
      <el-table-column label="微信公众号APPID" align="center" prop="appId" />
      <el-table-column label="微信商户ID" align="center" prop="mchId" />
      <el-table-column label="微信商户秘钥" align="center" prop="secretKey" />
      <el-table-column label="微信证书地址" align="center" prop="certPath" />
      <el-table-column label="商户名称" align="center" prop="shopName" />
      <el-table-column label="微信公众号秘钥" align="center" prop="appKey" class-name="small-padding fixed-width"/>
    </el-table>
...
<script>
import { listShopPayInfo} from "@/api/basicManage/shopPayInfo";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listShopPayInfo(this.queryParams).then(response => {
